          ...
          return (
            <MobileExperienceCard key={ind}>
              <a
                ...
                <p className="font-bold text-2xl hover:text-lightgreen text-center mb-3 underline mx-24">{experience.position}</p>
                <p className="font-semibold text-xl text-center my-3 mx-4">{experience.time}</p>
                <p className="text-center mt-3 text-lg mx-16 mb-20 md:mb-12">{experience.description}</p>
              </a>
